...
using PrjPriceTableLoanSimulation.Application.Services;
using PrjPriceTableLoanSimulation.Composition;
...
builder.Services.AddMediatR(typeof(SimulateRequestHandler).Assembly);
